...
struct O_PaperclipTests {
    ...
    @Test func routeABFailureShowsRecoverableError() {
        ...
        #expect(vm.locationInputError == "Failed to calculate the route from A to B. Please adjust the start or end point and try again.")
    }
    ...
    @Test func multiPointFailureReturnsToSelectionWithError() {
        ...
        #expect(vm.locationInputError == "Failed to calculate segment 1. Please adjust the selected points and try again.")
    }
}
