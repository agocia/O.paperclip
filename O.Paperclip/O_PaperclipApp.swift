...
private enum ModelContainerBootstrap {
    ...
    static func makeSharedContainer() -> ModelContainer {
        ...
        do {
            ...
            appendLog("Persistent store initialization failed. Falling back to in-memory storage: \(error.localizedDescription)")
        }
        ...
        do {
            ...
            appendLog("In-memory fallback initialization failed: \(error.localizedDescription)")
